...
const App = () => {
  ...
  const { subscribeToUnreadMessages, unsubscribeFromUnreadMessages } = useChatStore();
  ...
  // Subscribe to unread messages when authenticated
  useEffect(() => {
    if (authUser) {
  ...
  }, [authUser, subscribeToUnreadMessages, unsubscribeFromUnreadMessages]);
